...
const CategoryIcon = (props: IconProps) => (<div>
    <i>
        <svg className={`w-6 h-6 group-hover:hidden flex transition-all duration-1000`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <i>
        <svg className={`w-6 h-6 dark:bg-secondary light:bg-primary dark:text-secondary text-primary group-hover:flex hidden`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
